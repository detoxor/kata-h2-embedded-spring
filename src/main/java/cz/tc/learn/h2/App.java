 ...
 * @see <a href="https://docs.spring.io/spring/docs/current/spring-framework-reference/html/jdbc.html#jdbc-embedded-database-support">Embedded database support</a>
 * @see <a href="http://www.mkyong.com/spring/spring-embedded-database-examples/">Spring embedded database examples</a>
 */
public class App 
{
